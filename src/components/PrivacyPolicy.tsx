          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                At swipe, we are committed to protecting your privacy and personal data. This Privacy Policy explains how we collect, use, share, and protect your information when you use our platform. We comply with the Nigeria Data Protection Regulation (NDPR), GDPR, and other applicable data protection laws.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-primary/5 border-primary/20">
            ...
            <CardContent>
              ...
              <ul className="space-y-1 text-sm">
                <li><strong>Email:</strong> dpo@swipe.work</li>
                <li><strong>Address:</strong> Data Protection Officer, swipe, Lagos, Nigeria</li>
