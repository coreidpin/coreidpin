          ...
          <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-900">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                swipe is committed to protecting the privacy and personal data of all users, including those in the European Union. We comply with the General Data Protection Regulation (GDPR) and have implemented comprehensive measures to ensure your data rights are respected and protected.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  <strong>Email:</strong>
                  <span className="text-muted-foreground">dpo@swipe.work</span>
                </div>
                <div className="flex items-center gap-2">
                  <strong>Address:</strong>
                  <span className="text-muted-foreground">Data Protection Officer, swipe, Lagos, Nigeria</span>
                </div>
                <div className="flex items-center gap-2">
