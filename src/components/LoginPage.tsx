        ...
        <>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm">
              ...
              <a href="/get-started" className="text-white hover:text-white/80 underline">
                Sign up
              </a>
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-white/40 text-xs">
              By continuing, you are agreeing to GidiPIN's{' '}
              <a href="/terms" className="text-white font-bold hover:text-white/80 underline">
                Terms of Service
              </a>
              {' '}and{' '}
              <a href="/privacy" className="text-white font-bold hover:text-white/80 underline">
                Privacy Policy
              </a>
            </p>
          </div>
