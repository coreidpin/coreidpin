        ...
        <div className="relative z-10">
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <div className="relative group w-full">
              <div 
                className="text-4xl md:text-5xl font-mono font-bold tracking-widest text-white my-4 px-8 py-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm"
