    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are an AI talent matching assistant for nwanne platform. Analyze job requirements and provide talent matching insights for verified professionals.'
          },
          {
            role: 'user',
    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a compliance assistant for nwanne platform. Analyze compliance requirements for hiring global professionals.'
          },
          {
            role: 'user',
